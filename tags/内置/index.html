...
<head>
    <meta charset="utf-8">
    <meta name="keywords" content="标签: 内置, xiangyi">
...
<meta name="generator" content="Hexo 4.2.1"><link rel="alternate" href="/atom.xml" title="xiangyi" type="application/atom+xml">
</head>
        ...
        <div id="navContainer" class="nav-wrapper container">
            <div class="brand-logo">
                <a href="/" class="waves-effect waves-light">
                    ...
                    <span class="logo-span">xiangyi</span>
                </a>
            </div>
...
<div id="mobile-nav" class="side-nav sidenav">
    ...
    <div class="mobile-head bg-color">
        ...
        <div class="logo-name">xiangyi</div>
        <div class="logo-desc">
		...
		<a href="javascript:;">
            ...
            <ul  style="background:  ;" >
                ...
                <li>
                  ...
                  <a href="/about-me " style="margin-left:75px">
            ...
            <div class="description center-align">
                ...
                <script>
                    var typed = new Typed("#subtitle", {
                        strings: ['要大笑、要做梦、要与众不同。人生是一场伟大的冒险',''],
                        startDelay: 300,
                        typeSpeed: 100,
                        loop: true,
                        backSpeed: 50,
...
<script>
    ...
    $('.bg-cover').css('background-image', 'url(/medias/banner/4.jpg)');
</script>
...
<div id="tags" class="container chip-container">
    ...
    <article id="articles" class="container articles">
        <div class="row tags-posts">
            ...
            <div class="article tag-post col s12 m6 l4" data-tags="内置" data-aos="fade-up">
                <div class="card">
                    ...
                    <div class="card-content article-content">
                        <div class="publish-info">
                            ...
                            <span class="publish-author">
                                ...
                                <a href="/categories/%E5%86%85%E7%BD%AE/" class="post-category">
                                内置
                                </a>
    ...
    <div class="container row center-align" style="margin-bottom: 0px !important;">
        <div class="col s12 m8 l8 copy-right">
            ...
            <a href="/about" target="_blank">xiangyi</a>
            |&nbsp;基于&nbsp;<a href="https://hexo.io/" target="_blank">Hexo</a>
            |&nbsp;主题&nbsp;<a href="https://github.com/blinkfox/hexo-theme-matery" target="_blank">Matery</a>
            <br>
    ...
    <a href="https://github.com/xiangyi715" class="tooltipped" target="_blank" data-tooltip="访问我的GitHub" data-position="top" data-delay="50">
        <i class="fab fa-github"></i>
    </a>



    <a href="mailto:978270268@qq.com" class="tooltipped" target="_blank" data-tooltip="邮件联系我" data-position="top" data-delay="50">
    ...
    <a href="tencent://AddContact/?fromId=50&fromSubId=1&subcmd=all&uin=978270268" class="tooltipped" target="_blank" data-tooltip="QQ联系我: 978270268" data-position="top" data-delay="50">
        <i class="fab fa-qq"></i>
    </a>
...
(function() {
  ...
  hm.src = "https://hm.baidu.com/hm.js?8d4491bf7d774389d2e2dac1625bcf3f";
